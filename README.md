...
* С помощью технологии Page Object были реализованы методы логина, перевода с определённой карты на другую карту n'ой суммы и проверки баланса по карте. Написаны UI-тесты с использованием JUnit5, Gradle, Selenide, Lombok, AppVeyor. На найденный баг был заведен баг-репорт (см. GitHub Issues).
